print []                            # empty list
print list()                        # same as []
print [1, 2, 3]                     # as with tuples, items are comma sepaerated
...
print a
print a.count(1)                    # how many '1' are in the list
...
print a * 2                         # * also has special meaning
