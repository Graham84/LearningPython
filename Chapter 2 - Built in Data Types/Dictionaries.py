...
d = dict([('A', 1), ('Z', -1)])
e = dict({'Z': -1, 'A': 1})
print a == b == c == d == e             # are they all the same?        # indeed
...
print 'e' in d
d.clear()       # lets clean everything from this dictionary
print d
...
print d.pop('not-a-key', 'default-value')   # with a default value?         # we get the default value
...
print d                                      # as expected didn't work
